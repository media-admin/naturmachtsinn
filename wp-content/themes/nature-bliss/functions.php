...
if ( ! function_exists( 'nature_bliss_blocks_support' ) ) :
	...
	function nature_bliss_blocks_support() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => esc_html__( 'Small', 'nature-bliss' ),
					'shortName' => esc_html__( 'S', 'nature-bliss' ),
					'size'      => 14,
					'slug'      => 'small',
				),
				array(
					'name'      => esc_html__( 'Normal', 'nature-bliss' ),
					'shortName' => esc_html__( 'M', 'nature-bliss' ),
					'size'      => 18,
					'slug'      => 'normal',
				),
				array(
					'name'      => esc_html__( 'Large', 'nature-bliss' ),
					'shortName' => esc_html__( 'L', 'nature-bliss' ),
					'size'      => 42,
					'slug'      => 'large',
				),
				array(
					'name'      => esc_html__( 'Huge', 'nature-bliss' ),
					'shortName' => esc_html__( 'XL', 'nature-bliss' ),
					'size'      => 54,
					'slug'      => 'huge',
				),
			)
		...
		add_theme_support( 'editor-color-palette', array(
			array(
				'name'  => esc_html__( 'White', 'nature-bliss' ),
				'slug'  => 'white',
				'color' => '#ffffff',
			),
			array(
				'name'  => esc_html__( 'Black', 'nature-bliss' ),
				'slug'  => 'black',
				'color' => '#111111',
			),
			array(
				'name'  => esc_html__( 'Gray', 'nature-bliss' ),
				'slug'  => 'gray',
				'color' => '#f4f4f4',
			),
			array(
				'name'  => esc_html__( 'Blue', 'nature-bliss' ),
				'slug'  => 'blue',
				'color' => '1b8be0',
			),
			array(
				'name'  => esc_html__( 'Orange', 'nature-bliss' ),
				'slug'  => 'orange',
				'color' => '#fab702',
			),
			array(
				'name'  => esc_html__( 'Green', 'nature-bliss' ),
				'slug'  => 'green',
				'color' => '#568c11',
			),
		) );
